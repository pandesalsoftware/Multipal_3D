...
func mikuHair_inst():
	var mikuHairScene = preload("res://Meshes/Angels/Hair/HairInstScenes/miku_hair.tscn")
	var mikuInst = mikuHairScene.instantiate()
	var HPos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/HairPos1"
	#Remove Existing Children 
	for child in HPos.get_children():
		child.queue_free()
	#Add Child 
	HPos.add_child(mikuInst)
	if is_instance_valid(mikuInst):
		pass
#----------------------------------------------------------------------------------------------------------------------------
func _on_miku_hair_btn_pressed():
	#Runs the Hair Instance func 
	mikuHair_inst()
#Playing Animation
	AP.play("Posing001")
...
func lauraHair_inst():
	var lauraHairScene = preload("res://Meshes/Angels/Hair/HairInstScenes/laura_hair.tscn")
	var lauraInst = lauraHairScene.instantiate()
	var HPos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/HairPos1"
	#Remove Existing Children 
	for child in HPos.get_children():
		child.queue_free()
	#Add Child 
	HPos.add_child(lauraInst)
	if is_instance_valid(lauraInst):
		pass
#----------------------------------------------------------------------------------------------------------------------------
func _on_laura_hair_btn_pressed():
	#Runs the Hair Instance func 
	lauraHair_inst()
#Playing Animation
	AP.play("Posing001")
...
func agentHair_inst():
	var agentHairScene = preload("res://Meshes/Angels/Hair/HairInstScenes/fbi_casey_hair.tscn")
	var agentInst = agentHairScene.instantiate()
	var HPos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/HairPos1"
	#Remove Existing Children 
	for child in HPos.get_children():
		child.queue_free()
	#Add Child 
	HPos.add_child(agentInst)
	if is_instance_valid(agentInst):
		pass
#----------------------------------------------------------------------------------------------------------------------------
func _on_agent_hair_btn_pressed():
	#Runs the Hair Instance func 
	agentHair_inst()
#Playing Animation
	AP.play("Posing001")
...
func piHair_inst():
	var piHairScene = preload("res://Meshes/Angels/Hair/HairInstScenes/pi_casey_hair.tscn")
	var piInst = piHairScene.instantiate()
	var HPos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/HairPos1"
	#Remove Existing Children 
	for child in HPos.get_children():
		child.queue_free()
	#Add Child 
	HPos.add_child(piInst)
	if is_instance_valid(piInst):
		pass
#----------------------------------------------------------------------------------------------------------------------------
func _on_pi_hair_btn_pressed():
	#Runs the Hair Instance func 
	piHair_inst()
#Playing Animation
	AP.play("Posing001")
...
func agentFace_inst():
	var agentFaceScene = preload("res://Meshes/Angels/Face/FaceScenes/agent_cheekbones.tscn")
	var agentFEinst = agentFaceScene.instantiate()
	var FEpos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/FacePos"
	#Remove Existing Children 
	for child in FEpos.get_children():
		child.queue_free()
	#Add Child 
	FEpos.add_child(agentFEinst)
	#Checking for Instance 
	if is_instance_valid(agentFEinst):
		pass

#AWAITING BUTTON PRESS...
func _on_agent_face_btn_pressed():
	agentFace_inst()
	#Playing Animation 
	AP.play("Posing001")
...
#------------------------------------------------------------------------MARS----------FACIAL HAIR----------END
#AGENT ALEX---------FACIAL HAIR--------BEGIN---------------------------------------------------------------------------

func AgentFacialHair_inst():
	var AgentFacialHairScene = preload("res://Meshes/Angels/FacialHair/FacialHairInstScenes/bow_casey_stubble.tscn")
	var AgentFinst = AgentFacialHairScene.instantiate()
	var AgentFpos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/FacialHairPos"
	#Remove Existing Children 
	for child in AgentFpos.get_children():
		child.queue_free()
	#Add Child 
	AgentFpos.add_child(AgentFinst)
	#Checking for Instance 
	if is_instance_valid(AgentFinst):
		pass

#AWAITING BUTTON PRESS...
func _on_Agent_facial_hair_btn_pressed():
	AgentFacialHair_inst()
	#Playing Animation 
	AP.play("Posing001")

#------------------------------------------------------------------------AGENT----------FACIAL HAIR----------END
...
func johnnyBrows_inst():
	var johnnyBrowsScene = preload("res://Meshes/Angels/Brows/TSCN/johnny_brows.tscn")
	var johnnyBinst = johnnyBrowsScene.instantiate()
	var johnnyBpos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/BrowsPos"
	#Remove Existing Children 
	for child in johnnyBpos.get_children():
		child.queue_free()
	#Add Child 
	johnnyBpos.add_child(johnnyBinst)
	#Checking for Instance 
	if is_instance_valid(johnnyBinst):
		pass

#AWAITING BUTTON PRESS...
func _on_johnny_brows_btn_pressed():
	johnnyBrows_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func alexBrows_inst():
	var alexBrowsScene = preload("res://Meshes/Angels/Brows/TSCN/bow_casey_brows.tscn")
	var alexBinst = alexBrowsScene.instantiate()
	var Browspos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/BrowsPos"
	#Remove Existing Children 
	for child in Browspos.get_children():
		child.queue_free()
	#Add Child 
	Browspos.add_child(alexBinst)
	#Checking for Instance 
	if is_instance_valid(alexBinst):
		pass

#AWAITING BUTTON PRESS...
func _on_alex_brows_btn_pressed():
	alexBrows_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func miaBrows_inst():
	var miaBrowsScene = preload("res://Meshes/Angels/Brows/TSCN/mia_brows.tscn")
	var miaBinst = miaBrowsScene.instantiate()
	var Browspos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/BrowsPos"
	#Remove Existing Children 
	for child in Browspos.get_children():
		child.queue_free()
	#Add Child 
	Browspos.add_child(miaBinst)
	#Checking for Instance 
	if is_instance_valid(miaBinst):
		pass

#AWAITING BUTTON PRESS...
func _on_mia_brows_btn_pressed():
	miaBrows_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func lauraBrows_inst():
	var lauraBrowsScene = preload("res://Meshes/Angels/Brows/TSCN/laura_brows.tscn")
	var lauraBinst = lauraBrowsScene.instantiate()
	var Browspos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/BrowsPos"
	#Remove Existing Children 
	for child in Browspos.get_children():
		child.queue_free()
	#Add Child 
	Browspos.add_child(lauraBinst)
	#Checking for Instance 
	if is_instance_valid(lauraBinst):
		pass

#AWAITING BUTTON PRESS...
func _on_laura_brows_btn_pressed():
	lauraBrows_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func stevieEyes_inst():
	var stevieEyesScene = preload("res://Meshes/Angels/Eyes/EyesSceneInst/stevie_eyes.tscn")
	var stevieEinst = stevieEyesScene.instantiate()
	var stevieEpos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/EyePos"
	#Remove Existing Children 
	for child in stevieEpos.get_children():
		child.queue_free()
	#Add Child 
	stevieEpos.add_child(stevieEinst)
	#Checking for Instance 
	if is_instance_valid(stevieEinst):
		pass

#AWAITING BUTTON PRESS...
func _on_stevie_eyes_btn_pressed():
	stevieEyes_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func agentEyes_inst():
	...
	#Remove Existing Children 
	for child in Epos.get_children():
		child.queue_free()
	#Add Child 
	Epos.add_child(agentEinst)
	#Checking for Instance 
	if is_instance_valid(agentEinst):
		pass

#AWAITING BUTTON PRESS...
func _on_agent_eyes_btn_pressed():
	agentEyes_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func lauraEyes_inst():
	...
	for child in Epos.get_children():
		child.queue_free()
	#Add Child 
	Epos.add_child(lauraEinst)
	#Checking for Instance 
	if is_instance_valid(lauraEinst):
		pass

#AWAITING BUTTON PRESS...
func _on_laura_eyes_btn_pressed():
	lauraEyes_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func lauraMouth_inst():
	var lauraMouthScene = preload("res://Meshes/Angels/Mouths/LauraMouth.glb")
	var lauraMinst = lauraMouthScene.instantiate()
	var Mpos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/MouthPos"
	#Remove Existing Children 
	for child in Mpos.get_children():
		child.queue_free()
	#Add Child 
	Mpos.add_child(lauraMinst)
	#Checking for Instance 
	if is_instance_valid(lauraMinst):
		pass

#AWAITING BUTTON PRESS...
func _on_laura_mouth_btn_pressed():
	lauraMouth_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func agentMouth_inst():
	var agentMouthScene = preload("res://Meshes/Angels/Mouths/AgentCaseyMouth.glb")
	var agentMinst = agentMouthScene.instantiate()
	var Mpos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/MouthPos"
	#Remove Existing Children 
	for child in Mpos.get_children():
		child.queue_free()
	#Add Child 
	Mpos.add_child(agentMinst)
	#Checking for Instance 
	if is_instance_valid(agentMinst):
		pass

#AWAITING BUTTON PRESS...
func _on_agent_mouth_btn_pressed():
	agentMouth_inst()
	#Playing Animation 
	AP.play("Posing001")
...
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#---------------------------------------------------------------------------------------------------------------------------
#------------ RIGHTHAND_ITEM SECTION --------------------------------------------------------------------------BEGIN ------
#----------------------------------------------------------------------------------------------------------------------------

#ACE --------- RIGHTHAND_ITEM ---------BEGIN------------------------------------------------------------------------------------------

func aceFlag_inst():
	var aceFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/AceFlag.tscn")
	var aceFlaginst = aceFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(aceFlaginst)
	#Checking for Instance 
	if is_instance_valid(aceFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_ace_flag_btn_pressed():
	aceFlag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------ACE RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#ACHILLEAN----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func achillean_Flag_inst():
	var achilleanFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/AchilleanFlag.tscn")
	var achilleanFlaginst = achilleanFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(achilleanFlaginst)
	#Checking for Instance 
	if is_instance_valid(achilleanFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_achillean_flag_btn_pressed():
	achillean_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------ACHILLEAN RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#BISEXUAL----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func Bi_Flag_inst():
	var BiFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/BiFlag.tscn")
	var BiFlaginst = BiFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(BiFlaginst)
	#Checking for Instance 
	if is_instance_valid(BiFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_bi_flag_btn_pressed():
	Bi_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------BISEXUAL RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#RETROGAY----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func RetroGay_Flag_inst():
	var RetroGayFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/RetroGayFlag.tscn")
	var RetroGayFlaginst = RetroGayFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(RetroGayFlaginst)
	#Checking for Instance 
	if is_instance_valid(RetroGayFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_RetroGay_flag_btn_pressed():
	RetroGay_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------RETROGAY RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#GENDERFLUID----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func GenderFluid_Flag_inst():
	var GenderFluidFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/GenderfluidFlag.tscn")
	var GenderFluidFlaginst = GenderFluidFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(GenderFluidFlaginst)
	#Checking for Instance 
	if is_instance_valid(GenderFluidFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_GenderFluid_flag_btn_pressed():
	GenderFluid_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------GENDERFLUID RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#INTERSEX----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func Intersex_Flag_inst():
	var IntersexFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/IntersexFlag.tscn")
	var IntersexFlaginst = IntersexFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(IntersexFlaginst)
	#Checking for Instance 
	if is_instance_valid(IntersexFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_Intersex_flag_btn_pressed():
	Intersex_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------INTERSEX RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#LESBIAN----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func Lesbian_Flag_inst():
	var LesbianFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/LesbianFlag.tscn")
	var LesbianFlaginst = LesbianFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(LesbianFlaginst)
	#Checking for Instance 
	if is_instance_valid(LesbianFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_Lesbian_flag_btn_pressed():
	Lesbian_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------LESBIAN RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#NON-BINARY----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------


func NB_Flag_inst():
	var NBFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/NbFlag.tscn")
	var NBFlaginst = NBFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(NBFlaginst)
	#Checking for Instance 
	if is_instance_valid(NBFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_NB_flag_btn_pressed():
	NB_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------NB RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#PAN----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func Pan_Flag_inst():
	var PanFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/PanFlag.tscn")
	var PanFlaginst = PanFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(PanFlaginst)
	#Checking for Instance 
	if is_instance_valid(PanFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_Pan_flag_btn_pressed():
	Pan_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------PAN RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#TRANS----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func Trans_Flag_inst():
	var TransFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/TransFlag.tscn")
	var TransFlaginst = TransFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(TransFlaginst)
	#Checking for Instance 
	if is_instance_valid(TransFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_Trans_flag_btn_pressed():
	Trans_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------TRANS RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#2-SPIRIT----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------

func Two_Spirit_Flag_inst():
	var Two_SpiritFlagScene = preload("res://Meshes/Angels/R.Hand/Scenes/2Spirit.tscn")
	var Two_SpiritFlaginst = Two_SpiritFlagScene.instantiate()
	var RH_ItemPos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	#Remove Existing Children 
	for child in RH_ItemPos.get_children():
		child.queue_free()
	#Add Child 
	RH_ItemPos.add_child(Two_SpiritFlaginst)
	#Checking for Instance 
	if is_instance_valid(Two_SpiritFlaginst):
		pass

#AWAITING BUTTON PRESS...
func _on_Two_Spirit_flag_btn_pressed():
	Two_Spirit_Flag_inst()
	#Playing Animation 
	AP.play("Posing001")

#-------------------------------------------------------------------------------------------2-SPIRIT RIGHTHAND_ITEM------------------END
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
#NEXT----------RIGHTHAND_ITEM--------BEGIN------------------------------------------------------------------------------------------



#---------------------------------------------------------------------------------------------------------------------------
# QF RIGHTHAND_ITEM HERE......................................................................................................................................

func _on_Remove_R_Hand_pressed():
	var RH_Pos = $"../../../../Base_Angel/Armature/Skeleton3D/BoneAttachment3D/RightHandPos"
	var RH_PosChild = RH_Pos.get_children
	for child in RH_Pos.get_children():
		child.queue_free()
...
func laura_makeup_inst():
	var lauraMakeupScene = preload("res://Meshes/Angels/Makeup/TSCN/laura_blush.tscn")
	var lauraMakeupinst = lauraMakeupScene.instantiate()
	var MUpos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/MakeupPos"
	#Remove Existing Children 
	for child in MUpos.get_children():
		child.queue_free()
	#Add Child 
	MUpos.add_child(lauraMakeupinst)
	#Checking for Instance 
	if is_instance_valid(lauraMakeupinst):
		pass

#AWAITING BUTTON PRESS...
func _on_laura_makeup_btn_pressed():
	laura_makeup_inst()
	#Playing Animation 
	AP.play("Posing001")

#---------------------------------------------------------------------------LAURA----------MAKEUP----------END
#WILHELM---------MAKEUP--------BEGIN---------------------------------------------------------------------------

func wilhelm_makeup_inst():
	var wilhelmMakeupScene = preload("res://Meshes/Angels/Makeup/TSCN/wilhelm_eyeshadow.tscn")
	var wilhelmMakeupinst = wilhelmMakeupScene.instantiate()
	var MUpos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/MakeupPos"
	#Remove Existing Children 
	for child in MUpos.get_children():
		child.queue_free()
	#Add Child 
	MUpos.add_child(wilhelmMakeupinst)
	#Checking for Instance 
	if is_instance_valid(wilhelmMakeupinst):
		pass

#AWAITING BUTTON PRESS...
func _on_wilhelm_makeup_btn_pressed():
	wilhelm_makeup_inst()
	#Playing Animation 
	AP.play("Posing001")
...
func _on_remove_makeup_pressed():
	var makeupPos = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/MakeupPos"
	var makeupPosChild = makeupPos.get_children
	for child in makeupPos.get_children():
		child.queue_free()
#-----------------------------------------
#MAKEUP COLOR CHANGE HERE.................................................................................................................
@onready var makeupPos1 = $"../../../../Base_Angel/Armature/Skeleton3D/NeckBone/MakeupPos"
var MU_mat3D = StandardMaterial3D.new()

func _on_makeup_color_picker_color_changed(color):
	print("Makeup Color Picker changed!")
	#Check if makeupPos1 has any children to avoid out-of-bounds errors
	if makeupPos1.get_child_count() > 0:
		print("Makeup instance ready to change!")
		var makeupPosChild = makeupPos1.get_child(0)
		if makeupPosChild is MeshInstance3D:
			print("MeshInstance3D Detected.")
			#Ensure mat3D is a new instance of StandardMaterial3D 
			MU_mat3D.albedo_color = (color)
			makeupPosChild.material_override = MU_mat3D
			print("Makeup color changed!")
		else : 
			print("Nothing to change!")
#}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{
